...
# Aug 17 — 6 reels: 07:00, 10:00, 13:00, 16:00, 19:00, 22:00 NY
reels = [
    {
        "name": "aug17_1",
        "footage": f"{BASE}/1b1ec3c7-1_28.mp4",
        "face_union": (250, 780),
        "text_y": 1060,
        "hook_lines": [
            "I Quit Junk Food.",
        ...
        "cta_badge": "( Real food lives on the edges ↓ )",
    },
    {
        "name": "aug17_2",
        "footage": f"{BASE}/a4be1900-1_23.mp4",
        "face_union": (450, 900),
        "text_y": 1060,
        "hook_lines": [
            "Ranger Stopped Me.",
        ...
        "cta_badge": "( 3 tourists fall each year. This is why ↓ )",
    },
    {
        "name": "aug17_3",
        "footage": f"{BASE}/81c13fb4-1_24.mp4",
        "face_union": (80, 780),
        "text_y": 1060,
        "hook_lines": [
            "NYC Cab Charged $90.",
        ...
        "cta_badge": "( The train locals take to any airport ↓ )",
    },
    {
        "name": "aug17_4",
        "footage": f"{BASE}/5057fe3d-1_25.mp4",
        "face_union": (50, 580),
        "text_y": 1060,
        "hook_lines": [
            "Cruise Advertised $900.",
            "I Paid $1,800.",
        ],
        "cta_badge": "( The fees they hide until checkout ↓ )",
    },
    {
        "name": "aug17_5",
        "footage": f"{BASE}/6e451f36-1_26.mp4",
        "face_union": (160, 800),
        "text_y": 1060,
        "hook_lines": [
            "I Almost Booked Online.",
            "A Local Saved Me $400.",
        ],
        "cta_badge": "( The rate hotels never post online ↓ )",
    },
    {
        "name": "aug17_6",
        "footage": f"{BASE}/51da5758-1_27.mp4",
        "face_union": (80, 960),
        "text_y": 1060,
        "hook_lines": [
            "Window Seat. 2 X-Rays.",
            "Every Flight.",
        ],
        "cta_badge": "( Aisle seat reduces it by 30% ↓ )",
    },
]
