...
- `hook_y0 ≥ 270px` и `BOTTOM_ANCHOR = 1520px` — плашка в safe zone ✅
- `center_x = 540 ± 2px` — отцентровано горизонтально ✅
- `box_w ≤ 860px` | каждая визуальная строка ≤ 760px — не выходит за края плашки ✅
- Word wrap внутри плашки (pick_font, min_size=24) — хук не укорачивать ✅
