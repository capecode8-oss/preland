...
- `hook_y0 ≥ 1400` — текст в ЗЕЛЁНОЙ ЗОНЕ (нижняя часть кадра) ✅
- `cta_bottom ≤ 1820` — текстовый блок не выходит за нижний край ✅
- `center_x = 540 ± 2px` — текст отцентрован горизонтально ✅
- `box_w ≤ 860px` — не выходит за края ✅
- Белый фон (#FFFFFF с alpha 245) за текстом — читаем на любом клипе ✅

❌ hook_y0 < 1400 (текст выше зелёной зоны) → перерендерить с правильным bottom placement
❌ cta_bottom > 1820 (текст обрезан снизу) → сократить строки хука
