...
### ✅ 3. ТЕКСТ — позиция и оверлей

- `hook_y0 = 80` — текст прижат к верху ✅
- `center_x = 540 ± 2px` — текст отцентрован ✅
- `box_w ≤ 860px` — не выходит за края ✅
- `cta_bottom ≤ 1536px` — CTA badge не обрезан снизу ✅
- Белый фон (#FFFFFF с alpha 245) за текстом — читаем на любом клипе ✅

❌ Если CTA badge обрезан → уменьшить PAD_Y или сократить CTA текст
