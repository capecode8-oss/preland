...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[ПОЛНЫЙ КАПШЕН — структура ниже. Писать как kira-captions: простой язык, короткие предложения, от первого лица.]

SECOND HOOK: [первая строка капшена — deepens tension, не повтор хука]

CONTEXT: [2-3 предложения — почему это важно, что большинство не знает]

DETAIL: [конкретный факт/цифра/история — делает реальным]

PAYOFF: [что делать / что на самом деле происходит]

CTA:
[тематический CTA из банка ниже]

💾 Save this — [конкретная причина сохранить]
🔗 [МИНИ-ПРОДУКТ] → link in bio

SAVE LINE: [последняя строка — напоминание сохранить]

#[5-8 релевантных хештегов]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Длина: ~1800 символов | Тест: поймёт ли 15-летний американец? | Звучит как разговор, не статья?
```
...
Мини-продукт в CTA: [ЗАПОЛНИТЬ — спросить у пользователя]
