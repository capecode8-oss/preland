...
**Принцип:** рептильный мозг не думает — он реагирует. Зритель не принимает решение смотреть. Его тело принимает это решение за 0.3 секунды ДО того как мозг включился. Наша задача: нажать на один из 6 биологических рычагов в первом кадре.
...
**ОБЯЗАТЕЛЬНЫЕ ПРАВИЛА (нарушение = хук не выходит):**
- Первый кадр должен иметь VISUAL ANOMALY или HIGH-STATUS SIGNAL — никаких говорящих голов стоя без движения
- Hook text должен содержать: цифру, запрещённое слово, или незаконченное предложение
- Первые 3 секунды — ТОЛЬКО создаём зуд, никаких объяснений
- Мозг должен чувствовать что УПУСТИЛ что-то если свайпнул
- Никакой мотивации. Никаких "tips". Никаких "here's how to". ТОЛЬКО pattern breaks и open loops
- Если контент не вызывает лёгкой тревоги или сильного любопытства — ПЕРЕПИСАТЬ

**Mapping Trigger → наши архетипы:**
- T1 SURVIVAL THREAT → COMMAND INTERRUPT / NEAR MISS / PHYSICAL VIOLATION / SILENT DRAIN
- T3 STATUS THREAT → INSIDER LEAK / INSTITUTION LIE / YEARS WASTED
- T4 PATTERN BREAK → COMMAND INTERRUPT / UNIVERSAL MISTAKE / SPECIFIC NUMBER SHOCK
- T5 CURIOSITY GAP → INSIDER OBSERVATION / COUNTDOWN THREAT / YEARS WASTED
- T6 SOCIAL PROOF SHOCK → INSTITUTION LIE / UNIVERSAL MISTAKE / INSIDER LEAK

**Каждый хук должен активировать ОДИН доминирующий триггер.** Команда называет его перед финализацией.
...
⛔ ХЕШТЕГИ ЗАПРЕЩЕНЫ — не добавлять никогда
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
