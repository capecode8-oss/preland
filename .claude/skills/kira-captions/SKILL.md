...
## ⭐ ДЛИНА КАПШЕНА — ОБНОВЛЕНО СЕНТЯБРЬ 2026 (данные 4408 постов, исследование Socialinsider)

**Правило:** целевая длина **500–800 символов** (~150–200 слов). Не 1800–1950 — это было неправильно.

| Длина | Engagement | Вердикт |
|-------|-----------|---------|
| 0–125 | слабый | только хук, нет ценности |
| 126–300 | 3.94% | хорошо |
| **301–800** | **4.2%** | **ПИКОВАЯ ЗОНА** |
| 800–1200 | падение | scroll fatigue начинается |
| 1800+ | минимальный | алгоритм не помогает |

**⛔ СТАРАЯ ЦЕЛЬ 1850–1950 СИМВОЛОВ — ОТМЕНЕНА НАВСЕГДА.**
**✅ НОВАЯ ЦЕЛЬ: 500–800 символов = примерно 150–200 слов.**
