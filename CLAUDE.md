...
2. Аудит команды **Jordan · Mike · Alex · Sam · Dana · Red · Tyler · Maya · NOVA · VIC** (10 человек) запускается ВНУТРИ, ДО показа пользователю
3. Mike ставит прогноз просмотров (минимум 🟢 STRONG). Red пытается убить хук (должен поставить ✅ SURVIVED)
4. Пользователь видит ТОЛЬКО финальный результат после того как все 10 ✅
...
| 2 | `kira-hooks` | Пишем хук → аудит команды (10 чел) → body clearance → рендер |
...
### Команда (Jordan · Mike · Alex · Sam · Dana · Red · Tyler · Maya · NOVA · VIC) — 10 человек.
Текст: Jordan, Mike, Alex, Sam, Dana, Red, Tyler, Maya — аудируют хук и капшен.
Видео: NOVA (AI video prompts), VIC (visual director) — оценивают клип или генерируют AI-видео.
Mike ставит прогноз просмотров (порог: 🟢 STRONG = 5K+). Red пытается убить хук. Maya проверяет: перешлёт ли нашей аудитории 35+.
Если хоть один из 10 ставит ❌ — переписываем, не публикуем.
