...
2. Аудит команды **Jordan · Mike · Alex · Sam · Dana · Tyler** запускается ВНУТРИ, ДО показа пользователю
3. Пользователь видит ТОЛЬКО финальный результат после того как все 6 ✅
4. Черновики, "варианты", "предложения" — не показывать. Никогда.
