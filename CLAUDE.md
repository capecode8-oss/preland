...
- Jordan + команда пишут 3 варианта хука — адаптируют формулу вирала под тему Киры
- Первое лицо, конкретная цифра/место, ≤6 слов/строку, 3 строки
- Red пытается убить каждый хук
- Фокус-группа 100 американцев 30-75: Round 1 → 70+/100 стопят скролл, Round 2 → 20+ отправляют в DM
- Dorothy Test: поняла с первого раза?
