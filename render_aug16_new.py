...
# Aug 16 NEW — 3 reels: new niches (pharmacy, home danger, consumer rights)
reels = [
    {
        "name": "aug16_pharm",
        ...
        "cta_badge": "( The pharmacist never volunteers this ↓ )",
    },
    {
        "name": "aug16_home",
        ...
        "cta_badge": "( Windex + bleach = toxic gas in seconds ↓ )",
    },
    {
        "name": "aug16_rights",
