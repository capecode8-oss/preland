...
reels = [
    {
        "name": "comp_1",
        "footage": f"{BASE}/d5a019c8-Passenger_collecting_luggage_at___202608142015.mp4",
        "face_union": (200, 530),
        "text_y": 1060,
        "hook_lines": [
            "Never Do This.",
        ...
        "cta_badge": "( Thieves count on those 90 seconds ↓ )",
    },
    {
        "name": "comp_2",
        "footage": f"{BASE}/1899903e-Woman_walking_in_airport_terminal_202608142004.mp4",
        "face_union": (170, 490),
        "text_y": 1060,
        "hook_lines": [
            "Flight Attendants.",
        ...
        "cta_badge": "( Not your boarding pass ↓ )",
    },
    {
        "name": "comp_3",
        "footage": f"{BASE}/0890240b-Traveler_walking_outside_airport__1080p_202608142017.mp4",
        "face_union": (130, 480),
        "text_y": 1060,
        "hook_lines": [
            "Window Seat.",
            "Airlines Know The Cost.",
            "No One Tells You.",
        ],
        "cta_badge": "( Every long flight = 2 chest X-rays ↓ )",
    },
    {
        "name": "comp_4",
        "footage": f"{BASE}/9ee0a6e3-1_1.mp4",
        "face_union": (180, 980),
        "text_y": 1060,
        "hook_lines": [
            "It Called. Dead Silence.",
            "She Almost Hung Up.",
        ],
        "cta_badge": "( Hanging up confirms you're real ↓ )",
    },
    {
        "name": "comp_5",
        "footage": f"{BASE}/701aa650-Traveler_looking_inside_cruise_c__202608142030.mp4",
        "face_union": (380, 900),
        "text_y": 1060,
        "hook_lines": [
            "Hotels Hide A Rate.",
        ...
        "cta_badge": "( Two words at check-in. Most guests overpay ↓ )",
    },
    {
        "name": "comp_6",
