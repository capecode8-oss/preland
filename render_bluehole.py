...
FOOTAGE = "/home/user/preland/footage/1_1.mp4"
...
reel = {
    ...
    "cta_badge": "( What nobody tells tourists about this place ↓ )",
}
...
def make_overlay(r):
    ...
    # IRON RULE: hook always at top (y=80)
    hook_y0 = 80
    hook_y1 = hook_y0 + box_h
    cta_y0 = hook_y1 + BOX_GAP
    cta_y1 = cta_y0 + cta_box_h

    print(f"  {r['name']}: font={fsize}px hook_y0={hook_y0} hook_y1={hook_y1} cta_bottom={cta_y1}")
...
# Render: 300 frames = 10s @ 30fps, loop input if shorter
cmd = [
    FFMPEG, "-y",
...
if res.returncode != 0:
    ...
    # Extract preview JPG from frame 60 (2s)
    jpg_cmd = [
        FFMPEG, "-y", "-i", out_mp4,
